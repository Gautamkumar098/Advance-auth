...
function App() {
  ...
  const floatingColors = isDark
    ? {
        color1: "bg-green-500",
        color2: "bg-emerald-500",
        color3: "bg-lime-500",
      }
    : { color1: "bg-blue-400", color2: "bg-purple-400", color3: "bg-pink-400" };
